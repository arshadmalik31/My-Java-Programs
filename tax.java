...
class Tax 
{
	public static void main(String[] args) 
	{
		...
		{
			System.out.println("Your chargeable tax without saving is:"+salary*0.15);
		}
		else if(salary>1600000 && salary<=2000000)
		{
			System.out.println("Your chargeable tax without saving is:"+salary*0.2);
		}
		else if(salary>2000000 && salary<=3000000)
		{
			System.out.println("Your chargeable tax without saving is:"+salary*0.3);
		}
			else{
